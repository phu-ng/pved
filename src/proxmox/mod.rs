...
use crate::models::{IpAddress, NetworkInterface, NetworkInterfaceData, NodeData, QemuData, LxcInterface, LxcInterfaceData, LxcData, VmType, Vm, VmData};
...
// pub async fn get_vm_network(base_url: &str, proxmox_http_client: &Client, ) {
//
// }
